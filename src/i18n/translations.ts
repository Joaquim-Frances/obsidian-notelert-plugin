export const TRANSLATIONS = {
  "es": {
    "settings": {
      ...
      "emailPlan": {
        ...
        "loading": "Consultando tu plan y el uso de notificaciones...",
        "connect": "Verifica tu email o vincula la app para consultar tu cuota.",
        "counter": "{used} de {limit} notificaciones utilizadas",
        "counterFree": "{used} de {limit} notificaciones utilizadas",
        "freeDescription": "Free incluye 10 recordatorios al mes. Cada recordatorio cuenta una vez aunque use Android, email, Google Calendar, Telegram o varios canales.",
      ...
      "deliveryMode": {
        ...
        "androidSetup": "Descargar app para Android",
        "androidStoreLink": "Abrir Notelert en Google Play",
        "push": "Solo Android",
        "email": "Solo email",
    ...
    "notices": {
      ...
      "deliveryScheduledSummary": "✅ Recordatorio programado en: {channels}",
      "deliveryPartialSummary": "⚠️ Programado en {successful}. No se pudo programar en: {failed}",
    ...
    "datePicker": {
      ...
      "deliveryChannels": "Canales para este recordatorio:",
      "deliveryChannelsDesc": "Desactiva los canales que no quieras usar en esta ocasión.",
      "locationChannelHint": "Los recordatorios de ubicación solo se pueden entregar mediante Android.",
    ...
    "premiumPaywall": {
      ...
      "description": "Free te deja elegir el canal que prefieras. Notelert Pro te permite combinarlos para que cada recordatorio llegue donde importa.",
        ...
        "recurrenceLimit": "Los recordatorios recurrentes están disponibles con Notelert Pro.",
        "calendarLimit": "La vista de calendario está disponible con Notelert Pro.",
        "locationLimit": "Los recordatorios por ubicación están disponibles con Notelert Pro en Android.",
        "monthlyLimit": "Has alcanzado el límite de recordatorios de tu plan Free. Notelert Pro te da hasta 300 al mes.",
      "features": {
  ...
  "en": {
    "settings": {
      ...
      "emailPlan": {
        ...
        "loading": "Checking your plan and notification usage...",
        "connect": "Verify your email or link the app to see your allowance.",
        "counter": "{used} of {limit} notifications used",
        "counterFree": "{used} of {limit} notifications used",
        "freeDescription": "Free includes 10 reminders per month. Each reminder counts once even when it uses Android, email, Google Calendar, Telegram, or several channels.",
      ...
      "deliveryMode": {
        ...
        "androidSetup": "Download the Android app",
        "androidStoreLink": "Open Notelert in Google Play",
        "push": "Android only",
        "email": "Email only",
    ...
    "notices": {
      ...
      "deliveryScheduledSummary": "✅ Reminder scheduled in: {channels}",
      "deliveryPartialSummary": "⚠️ Scheduled in {successful}. Could not schedule in: {failed}",
    ...
    "datePicker": {
      ...
      "deliveryChannels": "Channels for this reminder:",
      "deliveryChannelsDesc": "Turn off any channels you do not want to use this time.",
      "locationChannelHint": "Location reminders can only be delivered through Android.",
    ...
    "premiumPaywall": {
      ...
      "description": "Free lets you choose the channel you prefer. Notelert Pro lets you combine them, so every reminder arrives where it matters.",
        ...
        "recurrenceLimit": "Recurring reminders are available with Notelert Pro.",
        "calendarLimit": "Calendar view is available with Notelert Pro.",
        "locationLimit": "Location reminders are available with Notelert Pro on Android.",
        "monthlyLimit": "You've reached your Free reminder limit. Notelert Pro gives you up to 300 each month.",
      "features": {
  ...
  "ca": {
    "settings": {
      ...
      "emailPlan": {
        "title": "Pla de notificacions", "freeLabel": "FREE", "premiumLabel": "PREMIUM", "trialLabel": "PREMIUM · PROVA",
        "loading": "Consultant el pla i l'ús de notificacions...", "connect": "Verifica l'email o vincula l'app per consultar la quota.",
        "counter": "{used} de {limit} notificacions utilitzades",
      ...
      "deliveryMode": {
        ...
        "androidSetup": "Descarregar l'app per a Android",
        "androidStoreLink": "Obrir Notelert a Google Play",
        "push": "Només Android",
        "email": "Només email",
    ...
    "notices": {
      ...
      "deliveryScheduledSummary": "✅ Recordatori programat a: {channels}",
      "deliveryPartialSummary": "⚠️ Programat a {successful}. No s'ha pogut programar a: {failed}",
    ...
    "datePicker": {
      ...
      "deliveryChannels": "Canals per a aquest recordatori:",
      "deliveryChannelsDesc": "Desactiva els canals que no vulguis utilitzar aquesta vegada.",
      "locationChannelHint": "Els recordatoris d'ubicació només es poden lliurar mitjançant Android.",
    ...
    "premiumPaywall": {
      ...
      "recurrenceLimit": "Els recordatoris recurrents estan disponibles amb Notelert Pro.",
      "calendarLimit": "La vista de calendari està disponible amb Notelert Pro.",
  ...
  "fr": {
    "settings": {
      ...
      "emailPlan": {
        "title": "Forfait de notifications", "freeLabel": "FREE", "premiumLabel": "PREMIUM", "trialLabel": "PREMIUM · ESSAI",
        ...
        "counter": "{used} notifications utilisées sur {limit}",
      ...
      "deliveryMode": {
        ...
        "androidSetup": "Télécharger l'application Android",
        "androidStoreLink": "Ouvrir Notelert dans Google Play",
    ...
    "notices": {
      ...
      "deliveryScheduledSummary": "✅ Rappel programmé dans : {channels}",
      "deliveryPartialSummary": "⚠️ Programmé dans {successful}. Échec dans : {failed}",
    ...
    "datePicker": {
      ...
      "deliveryChannels": "Canaux pour ce rappel :",
      "deliveryChannelsDesc": "Désactivez les canaux que vous ne souhaitez pas utiliser cette fois-ci.",
      "locationChannelHint": "Les rappels de lieu ne peuvent être livrés que via Android.",
      "timeNotification": "Temps",
    ...
    "premiumPaywall": {
      ...
      "recurrenceLimit": "Les rappels récurrents sont disponibles avec Notelert Pro.",
      "calendarLimit": "La vue calendrier est disponible avec Notelert Pro.",
  ...
  "de": {
    "settings": {
      ...
      "emailPlan": {
        "title": "Benachrichtigungstarif", "freeLabel": "FREE", "premiumLabel": "PREMIUM", "trialLabel": "PREMIUM · TEST",
        ...
        "counter": "{used} von {limit} Benachrichtigungen verwendet",
      ...
      "deliveryMode": {
        ...
        "androidSetup": "Android-App herunterladen",
        "androidStoreLink": "Notelert in Google Play öffnen",
        "push": "Nur Android",
        "email": "Nur E-Mail",
    ...
    "notices": {
      ...
      "deliveryScheduledSummary": "✅ Erinnerung geplant in: {channels}",
      "deliveryPartialSummary": "⚠️ Geplant in {successful}. Nicht möglich in: {failed}",
    ...
    "datePicker": {
      ...
      "deliveryChannels": "Kanäle für diese Erinnerung:",
      "deliveryChannelsDesc": "Deaktivieren Sie die Kanäle, die Sie diesmal nicht verwenden möchten.",
      "locationChannelHint": "Standorterinnerungen können nur über Android zugestellt werden.",
    ...
    "premiumPaywall": {
      ...
      "recurrenceLimit": "Wiederkehrende Erinnerungen sind mit Notelert Pro verfügbar.",
      "calendarLimit": "Die Kalenderansicht ist mit Notelert Pro verfügbar.",
  ...
  "pt": {
    "settings": {
      ...
      "emailPlan": {
        "title": "Plano de notificações", "freeLabel": "FREE", "premiumLabel": "PREMIUM", "trialLabel": "PREMIUM · TESTE",
        "loading": "Consultando o plano e o uso de notificações...", "connect": "Verifique seu e-mail ou vincule o app para consultar a cota.",
        "counter": "{used} de {limit} notificações usadas",
      ...
      "deliveryMode": {
        ...
        "androidSetup": "Baixar o app para Android",
        "androidStoreLink": "Abrir o Notelert no Google Play",
    ...
    "notices": {
      ...
      "deliveryScheduledSummary": "✅ Lembrete agendado em: {channels}",
      "deliveryPartialSummary": "⚠️ Agendado em {successful}. Não foi possível agendar em: {failed}",
    ...
    "datePicker": {
      ...
      "deliveryChannels": "Canais para este lembrete:",
      "deliveryChannelsDesc": "Desative os canais que não deseja usar desta vez.",
      "locationChannelHint": "Lembretes de localização só podem ser entregues pelo Android.",
    ...
    "premiumPaywall": {
      ...
      "recurrenceLimit": "Lembretes recorrentes estão disponíveis com o Notelert Pro.",
      "calendarLimit": "A visualização de calendário está disponível com o Notelert Pro.",
