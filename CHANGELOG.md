...
### Corregido
- Eliminada la propiedad legacy `notelertApiKey` de la configuración tipada del plugin.
- Publicada la rama de review validada por Obsidian desde el repositorio oficial del plugin.
